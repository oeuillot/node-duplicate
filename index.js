	...
	fs.readdir(directory, function(error, files) {
		if (error) {
			if (error.code === "EACCES") {
				console.log("Can not access to directory: " + directory);
				return callback(null);
			}
...
var intervalId = setInterval(function() {
	console.log("Stats: Directory:" + directories.running() + "/" + directories.length() + "  SHA1:" +
			filesSHA1.running() + "/" + filesSHA1.length() + " count:" + filesCount);
}, 2000);
